...
void main() {
  ...
  var btnClear = ButtonElement()
    ...
    ..name = 'btn_clear'
    ..text = 'Clear';
  var btnEvents = ButtonElement()
    ..id = 'btnEvents'
    ..name = 'btnEvents'
    ..text = 'Events Off';
  var br = BRElement();
  var display = DivElement()
    ..id = 'display'
    ..classes  = ['terminal'];
...
void showText(DivElement display, value) {
  // adding ParagraphElement with the value to the display DIV.
  display.nodes.add(ParagraphElement()..text=value);
